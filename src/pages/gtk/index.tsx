    ...
    <>
      <section>
        ...
        <div className="mb-5 w-80 mx-auto text-white" onClick={toggleHead}>
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out bg-blue-soft flex flex-col items-center font-semibold ${isHead ? 'max-h-dvh py-5 opacity-100 rounded-b-md' : 'max-h-0 opacity-0'}`}>
