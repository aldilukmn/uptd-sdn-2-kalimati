    ...
    <>
      <div className="my-10">
        <div className="lg:flex gap-10 mb-20">
          <img src="https://res.cloudinary.com/dhtfq9yw8/image/upload/v1717920310/uptd%20sdn%202%20kalimati/svg/vapqm0latukpxjjawzfu.svg" alt="logo" width={300} className="mx-auto lg:mb-0 mb-10" />
