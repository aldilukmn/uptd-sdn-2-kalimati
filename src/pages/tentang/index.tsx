    ...
    <>
      <div className="text-white">
        <section className="mt-8 mb-5 bg-blue rounded-xl p-4 lg:w-2/4 mx-auto">
          <h1 className="text-2xl font-semibold mb-2">Tentang</h1>
          <p className='text-justify'>Website ini dikelola oleh Tenaga Administrasi Sekolah atau Operator. Jika ada kritik dan saran dapat menghubungi nomor kontak di bawah ini. Terima Kasih.</p>
        </section>
